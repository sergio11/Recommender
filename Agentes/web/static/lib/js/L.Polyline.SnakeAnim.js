...
L.Polyline.include({
    ...
    _snakeForward: function (forward) {
        ...
        cPoint = this._snakeLatLngs[this._snakingRings][this._snakingVertices];
        nPoint = this._snakeLatLngs[this._snakingRings][this._snakingVertices + 1];

        if (cPoint != undefined && nPoint == undefined) {
        ...
        if (cPoint != undefined && nPoint != undefined) {
            ...
            var currPoint = this._map.latLngToContainerPoint(cPoint);
            var nextPoint = this._map.latLngToContainerPoint(nPoint);
